...
namespace ACM.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var model = new LoginViewModel() { Email = "andrew.milici@advancenational.com.au", Password = "Juddy05!", RememberMe = false };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                // Send an email with this link
                 ...
                 sb.AppendLine("<p>Someone (hopefully you) has requested a password reset for this email address.</p><br/>");
                 sb.AppendLine("Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a><br/>");
